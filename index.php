...
isset($_SESSION['lang']) ? $lang = $_SESSION['lang'] : $lang = 'esp';
    ...
    <div class="container body">
      <div class="main_container">
                ...
                <ul class="nav navbar-nav navbar-right">
                  ...
                  <li class="">
                    ...
                    <ul class="dropdown-menu dropdown-usermenu pull-right">
                      <li><a href="?lang=fr"><i class="fa fa-flag"></i> English</a></li>
                  ...
                  <li class="">
                    ...
                    <ul class="dropdown-menu dropdown-usermenu pull-right">
                      <li><a href="profil.php?lang=fr"><i class="fa fa-user pull-right"></i> My profil</a></li>
                      <li><a href="trans.php?lang=fr"><i class="fa fa-credit-card pull-right"></i> Transfer</a></li>
              ...
              <?php elseif($lang == 'ptg')  : ?>
                ...
                <ul class="nav navbar-nav navbar-right">
                  ...
                  <li class="">
                    ...
                    <ul class="dropdown-menu dropdown-usermenu pull-right">
                      <li><a href="profil.php?lang=ptg"><i class="fa fa-user pull-right"></i> Meu perfil</a></li>
                      <li><a href="trans.php?lang=ptg"><i class="fa fa-credit-card pull-right"></i> Transferência de dinheiro</a></li>
              ...
              <?php else : ?>
                <ul class="nav navbar-nav navbar-right">
                  ...
                  <li class="">
                    ...
                    <ul class="dropdown-menu dropdown-usermenu pull-right">
                      <li><a href="profil.php?lang=esp"><i class="fa fa-user pull-right"></i>Mi perfil</a></li>
                      <li><a href="trans.php?lang=esp"><i class="fa fa-credit-card pull-right"></i> Transferencia de fondos</a></li>
        ...
        <?php if($lang == 'fr') : ?>
          ...
          <?php include 'translate/francais.php'; ?>

        <?php elseif($lang == 'ptg')  : ?>

          <?php include 'translate/portugais.php'; ?>

        <?php else : ?>

          <?php include 'translate/espagnol.php'; ?>
