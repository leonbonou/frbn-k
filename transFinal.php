...
<head>
	...
	<style>
		#code_virement, #code_validation, #valid_virement, #valid_valid{
			display: none;
		}
	</style>
</head>
<body>
	<div class="page-content" style="background-image: url('transaction/images/wizard-v3.jpg')">
		...
		<?php if($lang == 'fr') : ?>
			...
			<?php include 'translate/transFinalF.php'; ?>

			<?php elseif($lang == 'ptg')  : ?>

			<?php include 'translate/transFinalP.php'; ?>

			<?php else : ?>

			<?php include 'translate/transFinalE.php'; ?>
